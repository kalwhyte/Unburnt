...
// import { createCravingLog } from "../../src/services/api/cravings";

// const INTENSITIES = [
//   { label: "Mild", value: 1, color: colors.tealLight },
//   { label: "Moderate", value: 2, color: "#E9C46A" },
//   { label: "Strong", value: 3, color: "#F4A261" },
//   { label: "Urgent", value: 4, color: "#E76F51" },
//   { label: "Overwhelming", value: 5, color: colors.danger },
// ];

// const TRIGGERS = ["Stress", "After Meal", "Alcohol", "Boredom", "Social", "Morning"];
...
//         intensity,
//         triggerId: selectedTrigger || undefined,
...
//         <Text style={s.title}>Log Craving</Text>
        
//         <View style={s.section}>
//           <Text style={s.label}>How strong is the urge?</Text>
...
//                   intensity === option.value && s.intensitySelected,
//                 ]}
//                 onPress={() => setIntensity(option.value)}
//               >
//                 <Text style={s.intensityLabel}>{option.label}</Text>
//               </TouchableOpacity>
//             ))}
//           </View>
//         </View>
...
//         <View style={s.section}>
//           <Text style={s.label}>What triggered it?</Text>
...
//                 style={[
//                   s.triggerOption,
//                   selectedTrigger === trigger && s.triggerSelected,
//                 ]}
//                 onPress={() =>
//                   setSelectedTrigger((prev) => (prev === trigger ? null : trigger))
//                 }
//               >
...
//           disabled={loading}
//         >
//           <Text style={s.saveBtnText}>{loading ? "Saving..." : "Save Log"}</Text>
//         </TouchableOpacity>
//       </ScrollView>
//     </SafeAreaView>
//   );
...
//   label: { ...T.body, color: colors.textMuted, marginBottom: 12 },
//   intensityGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
//   intensityOption: { flex: 1, minWidth: "30%", padding: 16, borderRadius: 12, alignItems: "center" },
//   intensitySelected: { borderWidth: 3, borderColor: colors.textPrimary },
//   intensityLabel: { ...T.bodyMedium, color: colors.textPrimary },
//   triggersGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
//   triggerOption: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20, backgroundColor: colors.surface },
//   triggerSelected: { backgroundColor: colors.teal },
//   triggerLabel: { ...T.bodyMedium, color: colors.textPrimary },
//   saveBtn: { backgroundColor: colors.teal, padding: 16, borderRadius: 12, alignItems: "center" },
//   saveBtnDisabled: { backgroundColor: colors.tealLight },
//   saveBtnText: { ...T.bodyMedium, color: colors.textPrimary },
// });
...
export default function LogCravingScreen() {
  ...
  const handleSubmit = async () => {
    await logCraving({ intensity, trigger, mood, outcome, notes })
    router.back()
  }
