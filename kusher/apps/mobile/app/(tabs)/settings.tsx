...
//         <Text style={[s.itemText, { color: colors.danger }]}>Logout</Text>
//       </TouchableOpacity>
//     </View>
//   );
// }
...
//   item: { paddingVertical: 16, borderBottomWidth: 0.5, borderBottomColor: colors.border },
//   itemText: { ...T.body, color: colors.textPrimary },
// });
